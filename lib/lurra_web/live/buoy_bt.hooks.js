...
let BuoyBt = {
  ...
  async updateBuoyData(){
    ...
    this.pushEvent("connected", {date: date, uid: uid, version: this.version, sensors: this.sensors, battery: battery, size: this.size}, (data, ref) => this.extracted_data_size = data.extracted_data_size)
  },
  async updateTime(){
    await this.setTime()
    this.updateBuoyData()
