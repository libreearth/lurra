...
let BuoyBt = {
  ...
  async updateBuoyData(){
    ...
    this.pushEvent("connected", {date: date, uid: uid, version: this.version, sensors: this.sensors, data_freq: this.data_freq, battery: battery, size: this.size}, (data, ref) => this.extracted_data_size = data.extracted_data_size)
  },
  async updateFrequency(){
    let sec = parseInt(window.prompt("Please enter a frequency in seconds:"))
    if (sec && sec > 0) {
